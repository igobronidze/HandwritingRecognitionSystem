...
public class NetworkControlPane extends VBox {
    ...
    private void initMainParametersPane() {
        ...
        TCHFieldLabel networkProcessorFieldLabel = new TCHFieldLabel("networkProcessorType", networkProcessorComboBox);
        flowPane.getChildren().add(networkProcessorFieldLabel);
        TCHTextField layersTextField = new TCHTextField(TCHComponentSize.MEDIUM);
        TCHFieldLabel layersFieldLabel = new TCHFieldLabel("hiddenLayers", layersTextField);
        flowPane.getChildren().add(layersFieldLabel);
        TCHTextField learningRateTextField = new TCHTextField(TCHComponentSize.SMALL);
        TCHFieldLabel learningRateFieldLabel = new TCHFieldLabel("learningRate", learningRateTextField);
        ...
        TCHFieldLabel transferFunctionFieldLabel = new TCHFieldLabel("transferFunction", transferFunctionComboBox);
        ...
        TCHFieldLabel charSequenceFieldLabel = new TCHFieldLabel("charSequence", charSequenceTextField);
        ...
        TCHFieldLabel maxIterationFieldLabel = new TCHFieldLabel("trainingMaxIteration", maxIterationTextField);
        ...
        TCHFieldLabel dataPerIterationFieldLabel = new TCHFieldLabel("dataPerIteration", dataPerIterationTextField);
        ...
        TCHFieldLabel minErrorFieldLabel = new TCHFieldLabel("minError", minErrorTextField);
